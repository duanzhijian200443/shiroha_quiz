...
class _QuestionListScreenState extends State<QuestionListScreen> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      final data = await DatabaseHelper.instance.getQuestionsByBank(widget.bankName);
  ...
  void _onSearchChanged(String query) {
    ...
    _debounce = Timer(const Duration(milliseconds: 400), () async {
      setState(() => _isLoading = true);
      try {
        final data = await DatabaseHelper.instance.searchQuestions(widget.bankName, query);
        if (mounted) setState(() { _questions = data; _isLoading = false; });
      } catch (e) {
        debugPrint('搜索题目失败: $e');
        if (mounted) setState(() => _isLoading = false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('${widget.bankName} 题库', style: const TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: _isLoading 
        ...
        : _questions.isEmpty
          ? const Center(child: Text('没有找到匹配的题目', style: TextStyle(color: Colors.grey)))
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                switch (q['type']) {
                  case 0: typeStr = '单选'; typeColor = Colors.blueAccent; break;
                  case 1: typeStr = '多选'; typeColor = Colors.orangeAccent; break;
                  case 2: typeStr = '填空'; typeColor = Colors.purpleAccent; break;
                  case 3: typeStr = '简答'; typeColor = Colors.greenAccent; break;
                }
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(typeStr, style: TextStyle(color: typeColor, fontSize: 12, fontWeight: FontWeight.bold)),
                            ),
                            IconButton(
                        ...
                        Row(
                          ...
                          children: [
                            TextButton.icon(
                              ...
                              label: const Text('编辑题目', style: TextStyle(color: Colors.blueAccent)),
                              onPressed: () {
