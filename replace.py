...
file_path = 'lib/services/ai_service.dart'
with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

replacement = '''  Future<List<Map<String, dynamic>>> _findQuestionAnchors(String rawText, Map<String, dynamic> profile) async {
...
pattern = re.compile(r'  // 核心重构：智能切片与调度引擎.*?  }', re.DOTALL)
