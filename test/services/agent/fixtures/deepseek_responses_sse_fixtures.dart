...
data: {"type":"response.output_item.added","output_index":0,"item":{"id":"item-call-1","type":"function_call","call_id":"call-1","name":"search_questions","arguments":""}}

event: response.function_call_arguments.delta
data: {"type":"response.function_call_arguments.delta","item_id":"item-call-1","output_index":0,"delta":"{\"query\":"}

event: response.function_call_arguments.delta
data: {"type":"response.function_call_arguments.delta","item_id":"item-call-1","output_index":0,"delta":"\"fixture\"}"}

event: response.function_call_arguments.done
data: {"type":"response.function_call_arguments.done","item_id":"item-call-1","output_index":0,"arguments":"{\"query\":\"fixture\"}"}

event: response.output_item.done
data: {"type":"response.output_item.done","output_index":0,"item":{"id":"item-call-1","type":"function_call","call_id":"call-1","name":"search_questions","arguments":"{\"query\":\"fixture\"}"}}
