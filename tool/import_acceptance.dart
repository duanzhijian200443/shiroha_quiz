...
class ImportAcceptanceCase {
  ...
  factory ImportAcceptanceCase.fromJson(Map<String, dynamic> json) {
    ...
    if (schemaVersion != 1) {
      throw UnsupportedAcceptanceCaseSchemaException(schemaVersion);
    }
...
class UnsupportedAcceptanceCaseSchemaException implements Exception {
  const UnsupportedAcceptanceCaseSchemaException(this.schemaVersion);
...
Future<int> runImportAcceptance({
  ...
  } on UnsupportedAcceptanceCaseSchemaException catch (error) {
    emitEvent({
      'stage': 'preflight',
      'status': 'unsupported_case_schema',
      'caseId': caseId,
      'schemaVersion': error.schemaVersion,
      'causeType': 'UnsupportedAcceptanceSchemaVersion',
    });
    return 2;
  } catch (e) {
    emitEvent({
